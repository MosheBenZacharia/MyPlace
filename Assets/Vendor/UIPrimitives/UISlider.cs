...
namespace UIPrimitives
{
	public class UISlider : ITHB.UI.UIElement, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
	{
		...
		protected void UpdateHoverPosition() {
			...
			hoverTransform.localPosition = hoverTransform.localPosition.X(width*(currentHoverPercent-.5f));
		}

		protected void UpdateCurrentPosition() {

			currentTransform.localPosition = currentTransform.localPosition.X(width*(actualPercent-.5f));
		}
