	...
	public class UIText : MonoBehaviour
	{
		...
		public void ExpandText ()
		{
			...
			if (myUITextAnimationType == UITextAnimationType.EaseInOut) {
				animationCurve = AnimationCurve.EaseInOut (Time.time, 0, Time.time + animationDuration, 1f);
			} else if (myUITextAnimationType == UITextAnimationType.Linear) {
				animationCurve = AnimationCurve.Linear (Time.time, 0, Time.time + animationDuration, 1f);
			}
		...
		public void SetText (string newText)
		{
			...
			if (myText.text == "") {
				...
				RetractText ();
				Invoke ("ExpandText", animationDuration);
			}
		}
